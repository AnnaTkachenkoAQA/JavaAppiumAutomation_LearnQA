...
public class Platform {
    ...
    public RemoteWebDriver getDriver() throws Exception {
        ...
        if(this.isAndroid()){
            ...
            throw new Exception("Can not detect type of the driver. Platform value: "+getPlatformVar());
        }
    }
    ...
    private DesiredCapabilities getIOSDesiredCapabilities(){
        ...
        capabilities.setCapability("app", "Users/anna/Desktop/JavaAppiumAutomation/apks/Wikipedia.app");
